<?php
/* ----------------------------------------------------------------------
   $Id: login.php,v 1.6 2003/05/05 16:50:30 r23 Exp $
...
define('ERROR_NO_USER_LOGIN', 'Fehler: Sie haben noch keinen Zugang! Bitte warten Sie auf Ihre Zugangsbestätigung!');
?>